...
public class adminHome_orderdetail extends AppCompatActivity {
    ...
    ArrayList<adminProductData> adminProductData1;
    adminHome_orderdetailAdapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.admin_orders_details);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adminProductData1 = new ArrayList<>();
        adapter = new adminHome_orderdetailAdapter(adminProductData1);
        recyclerView.setAdapter(adapter);

        backbtn = findViewById(R.id.back_button2);
        order = findViewById(R.id.admin_orders);
        ...
        confirm = findViewById(R.id.order_confirm);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(adminHome_orderdetail.this,admin_home.class);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(adminHome_orderdetail.this,admin_home.class);
                updatedata();
        ...
        order.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(adminHome_orderdetail.this,admin_order.class);
                startActivity(intent);
            }
        });
